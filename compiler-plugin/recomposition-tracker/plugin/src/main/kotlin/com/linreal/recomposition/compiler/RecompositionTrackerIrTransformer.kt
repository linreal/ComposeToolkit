...
class RecompositionTrackerIrTransformer(
    ...
    private val trackAnnoFqName = FqName("com.linreal.retracker.TrackRecompositions")

    @OptIn(UnsafeDuringIrConstructionAPI::class)
    private val recomposeTrackerSymbol by lazy {
        val id = CallableId(FqName("com.linreal.retracker"), Name.identifier("RecomposeTracker"))
